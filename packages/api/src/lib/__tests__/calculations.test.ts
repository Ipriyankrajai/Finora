...
describe("loan calculations", () => {
	describe("calculateMonthlyPayment", () => {
		...
		it("calculates 30-year mortgage payment", () => {
			...
			expect(Number(payment)).toBeGreaterThanOrEqual(189_520);
			expect(Number(payment)).toBeLessThanOrEqual(189_720);
		});
		...
		it("calculates car loan payment", () => {
			...
			expect(Number(payment)).toBeGreaterThanOrEqual(47_078);
			expect(Number(payment)).toBeLessThanOrEqual(47_278);
		});
	...
	describe("calculateCompoundInterest", () => {
		...
		it("calculates monthly compound interest", () => {
			...
			expect(Number(interest)).toBeGreaterThanOrEqual(51_062);
			expect(Number(interest)).toBeLessThanOrEqual(51_262);
		});
	});
	...
	describe("projectPayoff", () => {
		...
		it("detects insufficient payment", () => {
			...
			expect(projection.monthsRemaining).toBe(Number.POSITIVE_INFINITY);
		});
